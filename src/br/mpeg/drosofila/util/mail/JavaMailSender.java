...
public class JavaMailSender {
  ...
  //cria as propriedades necessárias para o envio de email
    public void senderMail(final MailJava mail, final String  autenticacaoSMPT) throws UnsupportedEncodingException, MessagingException {
        Properties props = new Properties();
        props.setProperty("mail.transport.protocol", "smtp");
        props.setProperty("mail.host", mail.getSmtpHostMail());
        props.setProperty("mail.smtp.auth", mail.getSmtpAuth());
        ...
        Authenticator auth = new Authenticator() {
            public PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication(autenticacaoSMPT, mail.getPassMail());
            }
        };
