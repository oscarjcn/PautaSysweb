...
public class TesteLimpaString {
	...
	public static String remover(String texto, List<String> listaSubstituicao){
		char caracteres[] = texto.toCharArray();
		for (String string : listaSubstituicao) {
			for (int i = 0; i < caracteres.length; i++) {
				if((int)caracteres[i]==(int)string.charAt(0))
					texto.replaceAll("[^A-z]", "");
			}
		}
